    ...
    public partial class AddEquipmentTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentRepairNote", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EquipmentRepairNote_Equipment_EquipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentRepairNote_EquipmentId",
                table: "EquipmentRepairNote",
                column: "EquipmentId");
        }
